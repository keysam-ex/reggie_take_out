...
import com.kjy.reggie.domain.*;
import com.kjy.reggie.service.*;
import com.kjy.reggie.mapper.OrdersMapper;
...
public class OrdersServiceImpl extends ServiceImpl<OrdersMapper, Orders>
    ...
    public void submit(Orders orders) {
        ...
        List<OrderDetail> orderDetails = shoppingCarts.stream().map((item) -> {
            ...
            amount.addAndGet(item.getAmount().multiply(new BigDecimal(item.getNumber())).intValue()); //累加总价
            return orderDetail;
